...
function Collide(aPlayer, aPlat) {
  if (aPlayer.y + aPlayer.r > aPlat.y && 
    aPlayer.y + aPlayer.r < aPlat.y + aPlat.h &&
    aPlayer.x + aPlayer.r > aPlat.x && 
    aPlayer.x - aPlayer.r < aPlat.x + aPlat.w){
    return true
  }
}
